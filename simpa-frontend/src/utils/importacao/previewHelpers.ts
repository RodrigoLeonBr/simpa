...
import type { MapeamentoStatus, PreviewCargaEnriquecida, ResolucaoUpload } from '../../types/importacao';
import type { CargaStatus, ResolucaoDraft } from './types';
...
export type { CargaStatus, ResolucaoDraft } from './types';
