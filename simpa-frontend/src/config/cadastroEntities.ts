...
export const CADASTRO_GRID_ITEMS: CadastroGridItem[] = [
  ...
  {
    route: 'vacina-grupos',
    title: 'Vacinas — Grupos Etários',
    tableName: 'vacina_grupos',
    mode: 'custom',
    description: 'Grupos etários alvo para cobertura vacinal.',
  },
  {
    route: 'vacina-faixa-grupo',
    title: 'Vacinas — Faixas → Grupo',
    tableName: 'vacina_faixa_grupo',
    mode: 'custom',
    description: 'De-para faixa etária NIES → grupo.',
  },
  {
    route: 'vacina-populacao',
    title: 'Vacinas — População Alvo',
    tableName: 'vacina_populacao_alvo',
    mode: 'custom',
    description: 'População alvo por grupo e ano.',
  },
  {
    route: 'vacina-esquema',
    title: 'Vacinas — Esquema de Doses',
    tableName: 'vacina_esquema',
    mode: 'custom',
    description: 'Nº de doses do esquema por vacina e grupo.',
  },
  {
    route: '/admin',
