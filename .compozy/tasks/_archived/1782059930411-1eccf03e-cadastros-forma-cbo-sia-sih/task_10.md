...
## Subtasks
- [x] 10.1 Registrar rotas no `CadastrosPage`
- [x] 10.2 Atualizar testes de card count e testIds
- [x] 10.3 Validar resolução de rota para novas páginas
...
## Tests
- Unit tests:
  - [x] Grid exibe novos cards
  - [x] `/cadastros/formas` renderiza FormasPage
  - [x] `/cadastros/cbos` renderiza CbosPage
- Integration tests:
  - [x] Navegação click-through do card para página destino
