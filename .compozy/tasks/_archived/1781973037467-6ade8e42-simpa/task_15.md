...
## Subtasks
- [x] 15.1 api/importacao.ts client methods
- [x] 15.2 UploadZone component
- [x] 15.3 HistoricoCargas table with actions
- [x] 15.4 Import page composing upload + history
...
## Tests
- Unit tests:
  - [x] Rejects non-CSV files client-side
  - [x] Preview response renders metadata fields
- Integration tests:
  - [x] Upload fixture triggers list refresh (mocked)
