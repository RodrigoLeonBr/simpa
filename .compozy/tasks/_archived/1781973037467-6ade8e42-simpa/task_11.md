...
dependencies:
  - task_09
  - task_10
amended_by: simpa-cadastros-sync
---

> **FilterBar atualizado** (2026-06-20): dropdown de unidade consome `GET /api/cadastros/estabelecimentos?perfil=APS` via `fetchEstabelecimentosAps()` — ver workflow arquivado [`simpa-cadastros-sync` task 09](../_archived/1781967665702-a4fca8ed-simpa-cadastros-sync/task_09.md).
